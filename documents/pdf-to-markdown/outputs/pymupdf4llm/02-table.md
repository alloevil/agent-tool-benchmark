# **Outer Planet Probe Comparison** 

The table below lists five outer-planet missions with their launch dates and current operational status. 

|**Probe**|**Launched**|**Primary target**|**Status 2026**|
|---|---|---|---|
